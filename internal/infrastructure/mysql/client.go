...
func NewClient(cfg *config.Config) *gorm.DB {
	...
	// 3. Auto-migraciones
	err = db.AutoMigrate(&UserModel{}, &RestaurantModel{}, &MenuItemModel{}, &QRCodeModel{}, &OperatingHourModel{}, &VerificationCodeModel{}, &ReservationModel{}, &OrderModel{}, &OrderItemModel{}, &CustomerModel{}, &StaffModel{})
