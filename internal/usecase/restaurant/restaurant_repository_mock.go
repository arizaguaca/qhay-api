...
func (_m *RestaurantRepository) Create(ctx context.Context, _a1 *domain.Restaurant) error {
...
func (_m *RestaurantRepository) Fetch(ctx context.Context) ([]*domain.Restaurant, error) {
	ret := _m.Called(ctx)
...
func (_m *RestaurantRepository) GetByID(ctx context.Context, id string) (*domain.Restaurant, error) {
...
func (_m *RestaurantRepository) GetByOwnerID(ctx context.Context, ownerID string) ([]*domain.Restaurant, error) {
...
func (_m *RestaurantRepository) Update(ctx context.Context, _a1 *domain.Restaurant) error {
	ret := _m.Called(ctx, _a1)
